...
function Login() {
  ...
  return (
    <div className="w-screen h-screen bg-[#B124A3]">
      ...
      {modal ? (
        <div
          className="modal fade z-40 fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
          id="exampleModal"
          tabIndex="-1"
          ...
          <div className="modal-dialog relative w-auto pointer-events-none">
            <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
              ...
              <div className="modal-body relative p-4">You have successfully logged in.</div>
            </div>
          </div>
        </div>
      ) : null}
        ...
        <div className="main-container bg-white">
          ...
          <div className="bg-white w-full m-3">
            <div className="m-10 flex flex-col items-center">
              {/* ✅ Replaced the old image with logo.svg */}
              <img className="h-20 w-20" src={logo} alt="Kinderjoy Logo" />
            ...
            <form className="grid grid-cols-1 gap-3 m-10" onSubmit={handleSubmit(onSubmit)}>
              ...
              <input
                ...
                required
              />
              <button className="px-5 flex justify-center p-3 bg-[#B124A3] text-white rounded-md" type="submit">
                {done ? <svg className="animate-spin h-5 w-5 outline outline-3 mr-1 rounded-full" viewBox="0 0 24 24"></svg> : null}
                <span>Login</span>
              </button>
            </form>
